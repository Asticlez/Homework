...
export default function Page() {
  ...
  const imageUrls = [
      "https://media.tenor.com/kAtdlmKDSZsAAAAM/black-black-man.gif",
      "https://media.tenor.com/Qsc0YiF-TJIAAAAM/black-black-guy.gif",
      "https://media.tenor.com/TiZSDQZs038AAAAM/blackmail-black.gif",
      "https://media.tenor.com/ph2GfjU5T-IAAAAM/black-child-black.gif",
      "https://media.tenor.com/t4UPRE5sQB0AAAAM/scream-peppermint.gif"
      ];
          ...
          <div className="container mx-auto px-4">
              ...
              <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {photos.map((photo) => {
                      ...
                      const imageUrl = imageUrls[photo.id % imageUrls.length];
                      ...
                      return (
                          ...
                          >
                              {/* Render the cycled image */}
                              <img src={imageUrl} alt="Avatar" className="mx-auto rounded-full w-32 h-32 mb-4" />
